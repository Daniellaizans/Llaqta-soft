        ...
        return (
            <>
                <div className="flex flex-row mb-5">
                    <a onClick={Navigate} className="flex items-center space-x-2 w-full text-white px-6 py-2 rounded-xl hover:border-l-4 hover:text-white hover:bg-gradient-to-r  hover:from-white/30 hover:to-transparent transition-all duration-100 ease-in-out cursor-pointer">

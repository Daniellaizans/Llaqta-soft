            ...
            <div className="fixed inset-0 flex items-center justify-center z-50">
                <div className="bg-white rounded-lg p-6 w-[75%]">
                    <div className="flex justify-between items-center">
                        <h2 className="text-xl font-bold mb-4">Registrar Colegio</h2>
                        <FontAwesomeIcon
                        icon={faTimes}
                        size="lg"
                    ...
                    <div className="flex flex-row justify-center items-center">
                        <div className="flex flex-col w-full">
                            <Inputs type="text" name="Nombre" placeholder="Nombre de la I.E:"/>
                    ...
                    <div className="flex justify-center items-center mt-2">
                        <button className="bg-[#0C1E33] px-7 py-2 text-center text-white rounded-xl">Registrar Colegios</button>
                    </div>
                </div>
            </div>
        </>
